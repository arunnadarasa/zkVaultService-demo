  ...
  return (
    <div className="p-6 rounded-2xl bg-[var(--bg-secondary)] border border-[var(--border)] hover:border-[var(--emerald-primary)]/50 shadow-[0_0_40px_rgba(16,185,129,0.08)] hover:shadow-[0_0_60px_rgba(16,185,129,0.2)] transition-all duration-300">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="text-xl font-semibold text-[var(--text-primary)]">Deposit</h3>
          <p className="text-sm text-[var(--text-secondary)]">Deposit USDc to shielded notes</p>
        </div>
      </div>
      ...
      <div className="p-4 rounded-xl bg-[var(--bg-tertiary)] border border-[var(--border)] mb-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-sm text-[var(--text-secondary)]">{mockAddress}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-2xl font-bold text-[var(--emerald-light)]">{mockBalance} USDc</span>
      ...
      <div className="relative mb-4">
        ...
        />
        <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--text-secondary)]">USDc</span>
      </div>
